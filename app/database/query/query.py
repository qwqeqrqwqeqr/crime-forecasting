...
QUERY_INSERT_CONGESTION = '''INSERT INTO public.congestion(day_month_year, weekday, hour, grid_number,report_count,life_population,name) VALUES (%s,%s,%s,%s,%s,%s,%s) ON CONFLICT (day_month_year,grid_number,hour) DO NOTHING;'''

QUERY_INSERT_DANGER_INDEX = '''INSERT INTO public.danger_index(grid_number, hc_danger_index, gc_danger_index, cc_danger_index,name) VALUES (%s,%s,%s,%s,%s) ON CONFLICT (grid_number) DO NOTHING;'''
...
VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) ON CONFLICT (day_month_year,grid_number) DO NOTHING;'''
