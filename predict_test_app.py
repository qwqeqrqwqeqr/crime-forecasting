...
- MODEL_PATH: model for test
- SCALER_PATH: scaler for test
...
if __name__ == '__main__':
    ...
    logger.info(f"[모델예측]을 진행합니다.")

    from app.model.life_population import LifePopulation
    from app.model.report import Report
    from app.service.predict.test.service import service
    service(LifePopulation(pd.concat(temp_life_population)),Report(pd.concat(temp_report)),grid_map,grid_area_map,model,scaler)