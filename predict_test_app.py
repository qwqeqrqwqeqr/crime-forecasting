...
- TRAIN_LIFE_POPULATION_PATH: train life population directory path (ex) "./test/data/life_population/"
- PREDICT_POPULATION_PATH: test life population directory path (ex) "./test/data/life_population/"
- MODEL: if you have model
- SCALER: if you have scaler
