...
PATH_노래연습장_ORIGIN="data/origin/치안유관업종/서울시노래연습장업인허가정보.csv"
PATH_단란주점_ORIGIN="data/origin/치안유관업종/서울시단란주점영업인허가정보.csv"
PATH_목욕장업_ORIGIN="data/origin/치안유관업종/서울시목욕장업인허가정보.csv"
PATH_숙박업_ORIGIN="data/origin/치안유관업종/서울시숙박업인허가정보.csv"
PATH_유흥주점_ORIGIN="data/origin/치안유관업종/서울시유흥주점영업인허가정보.csv"
PATH_인터넷컴퓨터게임시설_ORIGIN="data/origin/치안유관업종/서울시인터넷컴퓨터게임시설제공업인허가정보.csv"

PATH_경찰서_ORIGIN = "data/origin/치안시설/경찰서.csv"
PATH_치안센터_ORIGIN = "data/origin/치안시설/치안센터.csv"
...
AFTER_PATH
'''
PATH_경찰서_AFTER = "data/after/치안시설/경찰서.csv"
PATH_치안센터_AFTER = "data/after/치안시설/치안센터.csv"
